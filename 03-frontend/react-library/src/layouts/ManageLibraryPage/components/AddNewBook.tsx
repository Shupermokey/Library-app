    ...
    async function submitNewBook(){
        ...
        if(authState?.isAuthenticated && title !== '' && author !== '' && category !== 'Category'
            && description !== '' && copies >= 0){
                ...
                const submitNewBook = await fetch(url, requestOptions);
                if(!submitNewBook.ok){
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <form method="POST">
                        ...
                        <div>
                            <button type="button" className="btn btn-primary mt-3" onClick={submitNewBook}>Add Book</button>
                        </div>
                    </form>
